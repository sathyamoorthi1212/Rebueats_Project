...
exports.update = async (req, res) => {
    ...
    try {
        ...
        let newDoc = await UserModel.findById({ '_id': req.params.id });
        ...
        if (updateDoc && updateDoc.length !== 0) {
            ...
            return res.status(HttpStatus.OK).json({ 'success': true, 'message': req.i18n.__("USER_DATA_UPDATE_SUCCESS"), 'data': updatedDetails });
        }
