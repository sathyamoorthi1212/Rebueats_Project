...
exports.list = async (req, res) => {
    try {
        ...
        let getPromoCodeList = await PromoCodeModel.find(condition).sort(sortQuery).skip(pageQuery.skip).limit(pageQuery.take).select('_id promoName promoCode promoDescription startDate endDate promoOffer limit minimumOrderAmount promoType expireDate ').exec();
...
exports.getPromoCode = async (req, res) => {
    try {
        ...
        let getPromoCode = await PromoCodeModel.find(condition).sort(sortQuery).skip(pageQuery.skip).limit(pageQuery.take).select('_id promoName promoCode promoDescription startDate endDate promoOffer limit minimumOrderAmount promoType expireDate').exec();
