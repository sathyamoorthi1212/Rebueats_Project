...
exports.restaurantAdd = function (data) {
  ...
  data.restaurantTimingId = !isEmpty(data.restaurantTimingId) ? data.restaurantTimingId : "";

  // data.userId = !isEmpty(data.userId) ? data.userId : "";

  data.partnerId = !isEmpty(data.partnerId) ? data.partnerId : "";

  if (validator.isEmpty(data.partnerId)) {
    errors.partnerId = "partnerId field is required";
  }
  ...
  if (validator.isEmpty(data.restaurantTimingId)) {
    errors.restaurantTimingId = "restaurantTimingId field is required";
  }
...
exports.restaurantFoodItem = {
  tags: {
    body: {
      tag: Joi.string().required().error(errors => { return { message: "RESTAURANT_TAG_NAME_MUST_REQUIRED" } }),
    },
  },
  menu: {
    body: {
...
exports.restaurantUpdate = function (data) {
  let errors = {};
  data.restaurantName = !isEmpty(data.restaurantName) ? data.restaurantName : "";
  data.email = !isEmpty(data.email) ? data.email : "";
  data.mobile = !isEmpty(data.mobile) ? data.mobile : "";
