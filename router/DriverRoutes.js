...
router.route('/login').get(passportAuth, DriverController.currentLogin).post(validate(driverValidator.validation.login), DriverController.login);
router.route('/signup').post(DriverController.profileUpload, DriverController.signup);
...
router.route('/changeDriverStatus/:driverId').post(passportAuth, validate(driverValidator.validation.changeStatus), DriverController.statusChange);
...
router.route('/autoAssign/orderId/:orderId').post(passportAuth, DriverAllocationController.autoAssign);
