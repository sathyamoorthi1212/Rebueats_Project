...
const pushNotificationValidator = require('../validators/PushNotificationValidator');
...
router.route('/restaurant/scheduleOrder/:restaurantId').get(passportAuth, RestaurantController.scheduleOrders);
...
router.route('/restaurant/updateMenu/menuId/:menuId/restaurantId/:restaurantId').put(passportAuth, RestaurantController.updateRestaurantMenu);
...
/*Notification*/
router.route('/notification/addNotification').post(passportAuth, validate(notificationValidator.validation.add), NotificationController.addNotification);
router.route('/notification/updateNotification/:id').put(passportAuth, validate(notificationValidator.validation.update), NotificationController.updateNotification);
router.route('/notification/deleteNotification/:id').post(passportAuth, NotificationController.deleteNotification);
router.route('/notification/listNotification').get(passportAuth, NotificationController.listNotification);

/*Push Notification*/
router.route('/pushNotification/addPushNotification').post(passportAuth, validate(pushNotificationValidator.validation.add), PushNotificationController.addPushNotification);
